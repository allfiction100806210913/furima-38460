class OrderPurchaseRecord
  ...
  def save
    ...
    Order.create(prefecture_id: prefecture_id, postal_code: postal_code, city: city, building: building, addresses: addresses, phone_number: phone_number, purchase_record_id: purchase_record.id, token: token)
  end
end